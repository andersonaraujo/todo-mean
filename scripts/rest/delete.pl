...
if (@ARGV == 0) {
    print "SYNTAX: ./delete.pl /path/to/resource\n";
    print "\n";
    print "EXAMPLES:\n";
    print "    ./delete.pl /api/todos/56cd2cb45fee3389839dcc77\n";
    print "\n";
...
my $command="curl -k -v -X DELETE -H \"x-access-token: $sessionToken\" \'$host$ARGV[0]' 1>$out_file 2>$err_file";
